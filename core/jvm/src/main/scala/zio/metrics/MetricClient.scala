...
import zio.metrics.connectors.newrelic.NewRelicListener
import zio.metrics.connectors.newrelic.NewRelicPublisher
 ...
 */
// TODO: Rename that to MetricProxy
// Change this to a Streaming backend builder
// Also introduce the opposite like Batch backend builder
// xx.build will produce a Layer building Unit
// create zio.metrics.backends / NR / StatsD / Prometheus / ZIO
//
trait MetricClient {
